...
lang en_US.UTF-8
keyboard us
network --onboot yes --device eth0 --bootproto static --ip 192.168.1.10 --netmask 255.255.255.0 --gateway 192.168.1.1 --noipv6 --nameserver 192.168.1.1 --hostname c1.dude.localdomain --mtu 9000
network --onboot yes --device eth1 --bootproto static --ip 172.16.0.10 --netmask 255.255.255.0 --mtu 9000 --noipv6
